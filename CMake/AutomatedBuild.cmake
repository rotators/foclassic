...
function( DetectCI )
	...
	if( DEFINED ENV{CI} )
		...
		elseif( DEFINED ENV{GITHUB_ACTIONS} )
			set( CI "GitHub Actions" PARENT_SCOPE )
			...
			elseif( "$ENV{MATRIX_OS}" STREQUAL "windows-2016" )
				set( CI_FILE "${SOLUTION_FILE}" PARENT_SCOPE )
				set( CI_GENERATOR "Visual Studio 15 2017${CI_GENERATOR_SUFFIX}" PARENT_SCOPE )
				set( CI_TOOL "v100" PARENT_SCOPE )
			else()
				message( FATAL_ERROR "Unknown GitHub Actions OS ('$ENV{MATRIX_OS}')" )
			endif()
		elseif( DEFINED ENV{TRAVIS_APP_HOST} ) # Unused, left for reference
