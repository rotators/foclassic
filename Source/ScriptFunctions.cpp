...
ReservedScriptFunction ServerReservedFunctions[] =
{
    ...
    { &ServerFunctions.GlobalInvite, "global_invite", "void %s( Critter& leader, Item@ car, uint encounterDescriptor, int combatMode, uint& mapId, uint16& hexX, uint16& hexY, uint8& dir )" },
    ...
    { &ServerFunctions.CritterUseSkill, "critter_use_skill", "bool %s( Critter& cr, int skill, Critter@ targetCr, Item@ targetItem, Scenery@ targetScenery ) " },
