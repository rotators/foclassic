...
#define STR_INTERNAL_GAME_ENGINE_STAGE             (99995)
#define STR_INTERNAL_GAME_ENGINE_VERSION           (99996)
#define STR_INTERNAL_GAME_ENGINE_VERSION_CUSTOM    (99997)
#define STR_INTERNAL_SCRIPT_ENGINE_VERSION         (99998)
